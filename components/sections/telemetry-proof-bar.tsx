...
export function TrustStripSection() {
  return (
    <section
      ...
      className="relative overflow-hidden border-y border-border/70 bg-card/60 dark:bg-[#070d1e]/80 backdrop-blur-md py-4 sm:py-6 z-20 scroll-mt-16"
    >
      {/* Top gradient line */}
      <div
        ...
        <div className="flex flex-col gap-3.5 sm:gap-4">
          ...
          >
            {TRUST_ITEMS.map(({ label, icon: Icon }) => (
              <div
                key={label}
                className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-mono font-bold text-slate-700 dark:text-slate-300"
              >
