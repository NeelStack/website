...
import { Brain, Code2, Layers, Rocket, ShieldCheck, Globe, Zap, CheckCircle2, Activity } from 'lucide-react'
            ...
            {pillars.map((pillar, idx) => {
              ...
              return (
                <div
                  key={pillar.title}
                  className={cn(
                    'group flex flex-col gap-4 rounded-2xl border border-border/80 bg-card p-6 card-hover hover:border-primary/30 relative overflow-hidden animate-in-view',
                    staggerClasses[idx],
                    inView && 'is-visible'
                  )}
                >
