    ...
    <Section className="relative z-10 border-t border-border/50 py-16 sm:py-20">
      <Container size="lg">
        ...
        >
          ...
          {/* Inner content */}
          <div className="relative rounded-[2.4rem] bg-card/95 backdrop-blur-xl border border-border/40 p-8 sm:p-12 md:p-16 overflow-hidden flex flex-col items-center text-center z-10 space-y-7">
            {/* Ambient glow */}
            ...
            <h2 className="font-heading text-3xl sm:text-4xl md:text-5xl font-extrabold text-foreground tracking-tight leading-tight max-w-3xl relative z-10">
            ...
            <div className="relative z-20 pt-2">
              <Button
                ...
                variant="3d-yellow"
                size="xl"
                className="h-14 sm:h-15 px-10 text-base sm:text-lg rounded-2xl flex items-center gap-3 cursor-pointer shadow-xl hover:scale-105 transition-transform"
              >
