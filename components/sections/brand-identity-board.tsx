  ...
  return (
    <div className="w-full max-w-6xl mx-auto p-6 md:p-10 space-y-10 bg-slate-950/90 rounded-3xl border border-border/40 shadow-2xl backdrop-blur-2xl text-white">
      ...
      <div className="text-center space-y-2 border-b border-border/40 pb-6">
        <span className="text-xs font-bold uppercase tracking-widest text-violet-400">NeelStack Master System</span>
        ...
        <p className="text-xs text-slate-400 max-w-xl mx-auto">
          Point-Up 6-Sided Hexagon in Symmetrical Dual-Tone (Top-Half Royal Blue · Bottom-Half Rich Violet), Symmetrical Wordmark (N · ee · l · Stack), Dark Mode, Light Mode, and Monochrome.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        {/* Variant 1: Primary Dual-Color (Dark Container) */}
        <div className="bg-slate-900/90 rounded-2xl p-6 border border-border/50 flex flex-col justify-between space-y-6">
          <div className="flex justify-between items-center text-[10px] font-mono text-violet-400">
            ...
            <span>Dual-Color Symmetry</span>
          </div>

          <div className="p-6 rounded-xl bg-slate-950 border border-violet-500/20 flex items-center justify-center min-h-[120px]">
            <NeelStackLogo size="md" variant="full" />
          </div>

          <span className="text-xs text-slate-400 text-center">
            N (#3B82F6) · ee (#8B5CF6) · l (#3B82F6) · Stack (White)
          </span>
        </div>

        {/* Variant 2: Dark Mode Logo (Dark Container) */}
        <div className="bg-slate-900/90 rounded-2xl p-6 border border-border/50 flex flex-col justify-between space-y-6">
          <div className="flex justify-between items-center text-[10px] font-mono text-slate-400">
            <span>Dark Theme Canvas</span>
            <span>Midnight #070B14</span>
          </div>

          <div className="p-6 rounded-xl bg-[#070b14] border border-violet-500/20 flex items-center justify-center min-h-[120px]">
            <NeelStackLogo size="md" variant="full" />
          </div>
        ...
        {/* Variant 3: Light Mode Logo (Light Container) */}
        <div className="bg-slate-900/90 rounded-2xl p-6 border border-border/50 flex flex-col justify-between space-y-6">
          <div className="flex justify-between items-center text-[10px] font-mono text-slate-400">
            <span>Light Theme Canvas</span>
            <span>Clean Off-White #FAFBFF</span>
          </div>

          <div className="p-6 rounded-xl bg-[#fafbff] border border-slate-200 flex items-center justify-center min-h-[120px]">
            <NeelStackLogo size="md" variant="full" />
          </div>

          <span className="text-xs text-slate-400 text-center">
            N (#2563EB) · ee (#7C3AED) · l (#2563EB) · Stack (#0F172A)
          </span>
        </div>
