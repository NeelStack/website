      ...
      <Container className="space-y-16 relative z-10">
        ...
        <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          <motion.div
            ...
            className="p-6 rounded-3xl border border-primary/25 bg-card/70 backdrop-blur-md space-y-3 relative overflow-hidden"
          >
            <span className="text-xs font-bold uppercase tracking-wider text-primary bg-primary/10 px-3 py-1 rounded-full border border-primary/20 inline-block">
              Our Vision
            </span>
          ...
          <motion.div
            ...
            className="p-6 rounded-3xl border border-violet-500/25 bg-card/70 backdrop-blur-md space-y-3 relative overflow-hidden"
          >
            <span className="text-xs font-bold uppercase tracking-wider text-violet-400 bg-violet-500/10 px-3 py-1 rounded-full border border-violet-500/20 inline-block">
              Long-Term Vision
            </span>
            <h3 className="font-heading text-xl font-bold text-foreground">
