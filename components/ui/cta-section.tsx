...
export function CTASection({
  ...
  return (
    ...
    >
      <Container>
        <div className="relative rounded-3xl overflow-hidden bg-card border border-border p-10 md:p-16 text-center">
          {/* Background pattern */}
          <div className="absolute inset-0 bg-dot-pattern opacity-60" aria-hidden="true" />
          {/* Blue glow */}
          <div
            className="absolute inset-0"
            style={{
              background:
                'radial-gradient(ellipse 60% 50% at 50% 100%, oklch(0.62 0.22 258 / 10%) 0%, transparent 70%)',
            }}
            aria-hidden="true"
          />
