  ...
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all duration-200 outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:scale-[0.97] disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        'tactile-brand':
          'bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 hover:from-blue-500 hover:via-indigo-500 hover:to-violet-500 text-white font-black border-2 border-[#1e1b4b] dark:border-[#a78bfa] shadow-[4px_4px_0px_0px_#1e1b4b] dark:shadow-[4px_4px_0px_0px_#312e81,0_0_20px_rgba(139,92,246,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#1e1b4b] dark:hover:shadow-[6px_6px_0px_0px_#312e81,0_0_28px_rgba(139,92,246,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#1e1b4b] dark:active:shadow-[1px_1px_0px_0px_#312e81] transition-all duration-150',
        'tactile-yellow':
          'bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 hover:from-blue-500 hover:via-indigo-500 hover:to-violet-500 text-white font-black border-2 border-[#1e1b4b] dark:border-[#a78bfa] shadow-[4px_4px_0px_0px_#1e1b4b] dark:shadow-[4px_4px_0px_0px_#312e81,0_0_20px_rgba(139,92,246,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#1e1b4b] dark:hover:shadow-[6px_6px_0px_0px_#312e81,0_0_28px_rgba(139,92,246,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#1e1b4b] dark:active:shadow-[1px_1px_0px_0px_#312e81] transition-all duration-150',
        'tactile-primary':
          'bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 hover:from-blue-500 hover:to-cyan-400 text-white font-black border-2 border-[#1e3a8a] dark:border-[#38bdf8] shadow-[4px_4px_0px_0px_#172554] dark:shadow-[4px_4px_0px_0px_#0369a1,0_0_20px_rgba(6,182,212,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#172554] dark:hover:shadow-[6px_6px_0px_0px_#0369a1,0_0_28px_rgba(6,182,212,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#172554] dark:active:shadow-[1px_1px_0px_0px_#0369a1] transition-all duration-150',
        'tactile-secondary':
          'bg-gradient-to-b from-background/95 to-muted/80 dark:from-[#110c22]/95 dark:to-[#090615]/85 backdrop-blur-md text-foreground font-extrabold border-2 border-slate-700 dark:border-indigo-400 shadow-[4px_4px_0px_0px_#0f172a] dark:shadow-[4px_4px_0px_0px_#3730a3,0_0_20px_rgba(99,102,241,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:border-blue-600 dark:hover:border-indigo-300 hover:shadow-[6px_6px_0px_0px_#1e3a8a] dark:hover:shadow-[6px_6px_0px_0px_#3730a3,0_0_28px_rgba(99,102,241,0.6)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#0f172a] dark:active:shadow-[1px_1px_0px_0px_#3730a3] transition-all duration-150',
        'tactile-emerald':
          'bg-gradient-to-b from-emerald-400 via-emerald-500 to-teal-600 text-white font-black border-2 border-[#065f46] dark:border-[#34d399] shadow-[4px_4px_0px_0px_#064e3b] dark:shadow-[4px_4px_0px_0px_#047857,0_0_20px_rgba(16,185,129,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#064e3b] dark:hover:shadow-[6px_6px_0px_0px_#047857,0_0_28px_rgba(16,185,129,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#064e3b] dark:active:shadow-[1px_1px_0px_0px_#047857] transition-all duration-150',
        'tactile-violet':
          'bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white font-black border-2 border-[#581c87] dark:border-[#c084fc] shadow-[4px_4px_0px_0px_#3b0764] dark:shadow-[4px_4px_0px_0px_#6b21a8,0_0_20px_rgba(192,132,252,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#3b0764] dark:hover:shadow-[6px_6px_0px_0px_#6b21a8,0_0_28px_rgba(192,132,252,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#3b0764] dark:active:shadow-[1px_1px_0px_0px_#6b21a8] transition-all duration-150',
        '3d-brand':
          'bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 hover:from-blue-500 hover:via-indigo-500 hover:to-violet-500 text-white font-black border-2 border-[#1e1b4b] dark:border-[#a78bfa] shadow-[4px_4px_0px_0px_#1e1b4b] dark:shadow-[4px_4px_0px_0px_#312e81,0_0_20px_rgba(139,92,246,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#1e1b4b] dark:hover:shadow-[6px_6px_0px_0px_#312e81,0_0_28px_rgba(139,92,246,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#1e1b4b] dark:active:shadow-[1px_1px_0px_0px_#312e81] transition-all duration-150',
        '3d-yellow':
          'bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-600 hover:from-blue-500 hover:via-indigo-500 hover:to-violet-500 text-white font-black border-2 border-[#1e1b4b] dark:border-[#a78bfa] shadow-[4px_4px_0px_0px_#1e1b4b] dark:shadow-[4px_4px_0px_0px_#312e81,0_0_20px_rgba(139,92,246,0.45)] hover:-translate-x-0.5 hover:-translate-y-0.5 hover:shadow-[6px_6px_0px_0px_#1e1b4b] dark:hover:shadow-[6px_6px_0px_0px_#312e81,0_0_28px_rgba(139,92,246,0.65)] active:translate-x-0.5 active:translate-y-0.5 active:shadow-[1px_1px_0px_0px_#1e1b4b] dark:active:shadow-[1px_1px_0px_0px_#312e81] transition-all duration-150',
