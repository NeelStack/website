...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      'Browser-native productivity suite featuring privacy-first PDF tools, image processing, document conversion, and AI-powered workflow utilities with zero server-side data retention.',
    status: 'live',
    icon: FileText,
    color: 'text-blue-400',
    ...
    features: [
      ...
      { label: 'Document Tools — Text & Format Converters, Code Formatters' },
      { label: 'AI Tools — Smart Summarization, OCR & Vector Embeddings' },
    ],
